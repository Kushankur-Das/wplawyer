...
<section class="banner">
      <div class="banner__right">
        <img
          id="banner__image"
          src="<?php echo (get_template_directory_uri(). '/assets/images/hero__image.png') ?>"
          alt="Banner Image"
        />
      ...
      <img src="<?php echo (get_template_directory_uri(). '/assets/images/company__logo.png') ?>" alt="Our Partner Brand Logo" />
    </section>
    <section class="help center">
      ...
      <div class="help__boxes center">
        <div>
          <img src="<?php echo (get_template_directory_uri(). '/assets/images/circle__layer.png') ?>" alt="Circle Icon" />
        ...
        <div>
          <img src="<?php echo (get_template_directory_uri(). '/assets/images/bag.png') ?>" alt="Bag Icon" />
          <h3>Enviromental Law</h3>
          <p>
            Environmental Legal Issue might occur since the planned business
            activities are designed
        ...
        <div>
          <img src="<?php echo (get_template_directory_uri(). '/assets/images/rocket.png') ?>" alt="Rocket Icon" />
          <h3>Enviromental Law</h3>
          <p>
            Environmental Legal Issue might occur since the planned business
            activities are designed
        ...
        <div>
          <img src="<?php echo (get_template_directory_uri(). '/assets/images/user__arrows.png') ?>" alt="Arrow Icon" />
          <h3>Enviromental Law</h3>
          <p>
            Environmental Legal Issue might occur since the planned business
            activities are designed
    ...
    <section class="count center" style="background: url(<?php echo (get_template_directory_uri(). '/assets/images/bg__pattern.png') ?>);">
    ...
    <section class="testimonial center">
      ...
      <div class="testimonial__content center">
        <div class="testimonial__div center">
          ...
          <img src="<?php echo (get_template_directory_uri(). '/assets/images/testimony__image.png') ?>" alt="Testimonial Image" />
            <div>
    ...
    <section class="question center">
      <div>
        ...
        <div class="question__button center">
          <img src="<?php echo (get_template_directory_uri(). '/assets/images/call__logo.png') ?>" alt="Call Logo" />
          <span>Call now</span>
        </div>
      </div>
      <img src="<?php echo (get_template_directory_uri(). '/assets/images/man__image.png') ?>" alt="Man Image" />
    </section>
